...
export default function PostForm({ editMode, post, submit }) {
  ...
  const handleSubmit = (e) => {
    ...
    editMode ? submit(post._id, newData) : submit(newData);
    setFormValues({
      title: "",
      content: "",
      tags: [],
  ...
  return (
    ...
    <div>
      <button onClick={toggleModal}>
        {editMode ? "Edit Post" : <i class="fa-solid fa-plus fa-2x"></i>}
      </button>
      <div className={openModal && "openModal requires-no-scroll"}>
        {" "}
        {openModal ? (
